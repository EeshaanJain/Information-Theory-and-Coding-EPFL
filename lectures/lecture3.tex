...
{
x_i  &|[minimum width=2em]|& P(x_i) &|[minimum width=4em]| Code &       &|[minimum width=4em]|      &       &|[minimum width=4em]|  &   &|[minimum width=4em]|  &   &\\
a &&0.25     &        & 0.25  &   &0.25   &   &0.45&  &0.55&\\
b && 0.2    &        & 0.2  &   &0.2   &   &0.30&  &0.45&\\
c && 0.15   &     & 0.15  &   &0.3   &   &0.25&  &   &\\
d && 0.15    &        &0.15   &   &0.25   &   &   &   &   &\\
e && 0.15    &        &0.25   &   &       &   &   &   &   &\\
f && 0.1    &        &   &   &       &   &   &   &   &\\
};
...
\draw (Mat-6-3.east)-|node[above,pos=0.4]{1000}++(2em,-1em) coordinate(aa) --++(1em,0) |- (Mat-6-5.west);
\draw (Mat-7-3.east)-|node[below,pos=0.4]{1001} (aa);
\draw (Mat-4-5.east)-|node[above,pos=0.4]{1000}++(2em,-1em) coordinate(aa) --++(1em,0) |- (Mat-4-7.west);
\draw (Mat-5-5.east)-|node[below,pos=0.4]{1001} (aa);
\draw (Mat-3-7.east)-|node[above,pos=0.4]{1000}++(2em,-1em) coordinate(aa) --++(1em,0) |- (Mat-2-9.west);
\draw (Mat-5-7.east)-|node[below,pos=0.4]{1001} (aa);
\draw (Mat-3-7.east)-|node[above,pos=0.4]{1000}++(2em,-1em) coordinate(aa) --++(1em,0) |- (Mat-2-9.west);
\draw (Mat-5-7.east)-|node[below,pos=0.4]{1001} (aa);
\end{tikzpicture}
\end{eg}